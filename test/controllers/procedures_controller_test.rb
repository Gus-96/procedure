...
class ProceduresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post procedures_url, params: { procedure: { description: @procedure.description, title: @procedure.title } }
    end
  ...
  test "should update procedure" do
    patch procedure_url(@procedure), params: { procedure: { description: @procedure.description, title: @procedure.title } }
